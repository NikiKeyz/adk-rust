...
adk-model = { version = "0.9.0", features = ["gemini"] }        # Google Gemini (default)
adk-model = { version = "0.9.0", features = ["openai"] }        # OpenAI GPT-5
adk-model = { version = "0.9.0", features = ["anthropic"] }     # Anthropic Claude
adk-model = { version = "0.9.0", features = ["deepseek"] }      # DeepSeek
adk-model = { version = "0.9.0", features = ["groq"] }          # Groq (ultra-fast)
